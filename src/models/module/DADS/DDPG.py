...
from .Utility_Functions import OU_Noise_Exploration
...
class DDPG(Base_Agent):
    ...
    def __init__(self, config, environment):
        ...
        self.exploration_strategy = OU_Noise_Exploration(self.action_size, self.hyperparameters["mu"],
    ...
    def pick_action(self, state=None):
        ...
        if state is None: state = self.state.float().unsqueeze(0).to(self.hyperparameters["device"])
